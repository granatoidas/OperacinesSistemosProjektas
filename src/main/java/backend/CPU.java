...
public class CPU {
	...
	public void SET_CDR() {
		...
		byte d = ram[hex(SPtmp[0])][hex(SPtmp[1])];
		SPtmp = iterateAndConvert(SP, 0);
		byte e = ram[hex(SPtmp[0])][hex(SPtmp[1])];
		this.CDR[0] = a;
		this.CDR[1] = b;
		this.CDR[2] = c;
		this.CDR[3] = d;
	...
	public void GET_AR() {
		...
		byte c = this.AR[2];
		byte d = this.AR[3];
		Byte[] SPtmp = iterateAndConvert(SP, 1);
		ram[hex(SPtmp[0])][hex(SPtmp[1])] = a;
		SPtmp = iterateAndConvert(SP, 2);
		ram[hex(SPtmp[0])][hex(SPtmp[1])] = b;
		SPtmp = iterateAndConvert(SP, 3);
		ram[hex(SPtmp[0])][hex(SPtmp[1])] = c;
